...
<div class="konten">
  <div class="sidebar">
    ...
    <a class="active"  style="color:white" href="./pengajuan.php"><i class='fas fa-file-upload' style='font-size:25px;margin-right:20px'></i>Pengajuan Pembayaran</a>
    <a  href="./pembayaran.php" style="color:white" ><i class='fas fa-receipt' style='font-size:20px;margin-right:20px'></i> Pembayaran</a>
    <div class="logout">
        ...
        while($row = $sql->fetch_assoc()){
          ...
          <tr>
            ...
            <td style="text-align:center">
              <a href="pengajuan_edit.php?id_pembayaran='. $row['id_pembayaran'] .'"<button type="button" class="btn btn-success">Validasi</button>
            </td>
          </tr>
          ';
        }
