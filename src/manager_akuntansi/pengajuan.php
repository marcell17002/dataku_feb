    ...
    <div clas="container">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <h5 style="padding-bottom:5%"> Manager Keuangan </h5>
        </div>
      </div>
    </div>
      ...
      if($sql->num_rows > 0){
        ...
        while($row = $sql->fetch_assoc()){
          ...
          <tr>
            ...
            <td><a href="pengajuan_edit.php?id_pembayaran='. $row['id_pembayaran'] .'"<i class="fas fa-edit" style="font-size:20px;margin-right:20px"></i> Validasi </a></td>
          </tr>
          ';
        }
      }else{
